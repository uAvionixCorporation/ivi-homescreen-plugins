...
class SkyplayRenderSurface final : public PlatformView, public flutter::Plugin {
 public:
  ...
  SkyplayRenderSurface(int32_t id,
                   std::string viewType,
                   int32_t direction,
                   double top,
                   double left,
  ...
  ~SkyplayRenderSurface() override;

  // Disallow copy and assign.
  SkyplayRenderSurface(const SkyplayRenderSurface&) = delete;
  SkyplayRenderSurface& operator=(const SkyplayRenderSurface&) = delete;
 ...
 private:
  ...
  skyplay_render_Context* context_{};
